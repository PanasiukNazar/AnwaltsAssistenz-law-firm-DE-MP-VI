    ...
    _initEvents() {
        this._supportPointerEvents
            ? (EventHandler.on(this._element, EVENT_POINTERDOWN, (e) =>
              ...
              EventHandler.on(this._element, EVENT_POINTERUP, (e) =>
                  this._end(e),
              ),
            ...
            : (EventHandler.on(this._element, EVENT_TOUCHSTART, (e) =>
              ...
              EventHandler.on(this._element, EVENT_TOUCHMOVE, (e) =>
                  this._move(e),
              ),
              EventHandler.on(this._element, EVENT_TOUCHEND, (e) =>
                  this._end(e),
              ));
    }
...
class Carousel extends BaseComponent {
    ...
    to(e) {
        ...
        if (this._isSliding)
            return void EventHandler.one(this._element, EVENT_SLID, () =>
                this.to(e),
            );
    ...
    _addEventListeners() {
        this._config.keyboard &&
            EventHandler.on(this._element, EVENT_KEYDOWN$1, (e) =>
                this._keydown(e),
            ),
    ...
    _setActiveIndicatorElement(e) {
        ...
        n &&
            (n.classList.add('active'), n.setAttribute('aria-current', 'true'));
    }
    _updateInterval() {
    ...
    _slide(e, t = null) {
        ...
        const n = this._getActive(),
            ...
            s =
                t ||
                getNextActiveElement(this._getItems(), n, i, this._config.wrap);
        if (s === n) return;
...
class Collapse extends BaseComponent {
        ...
        if (
            (this._config.parent &&
                (e = this._getFirstLevelChildren(SELECTOR_ACTIVES)
                    ...
                    .map((e) =>
                        Collapse.getOrCreateInstance(e, { toggle: !1 }),
                    )),
    ...
    _configAfterMerge(e) {
        return (
            (e.toggle = Boolean(e.toggle)), (e.parent = getElement(e.parent)), e
        );
    }
    _getDimension() {
...
class Dropdown extends BaseComponent {
    ...
    show() {
        ...
        if (
            !EventHandler.trigger(this._element, EVENT_SHOW$5, e)
                .defaultPrevented
        ) {
            if (
                (this._createPopper(),
    ...
    _completeHide(e) {
        if (
            !EventHandler.trigger(this._element, EVENT_HIDE$5, e)
                .defaultPrevented
        ) {
...
class Backdrop extends Config {
    ...
    _AnwaltsAssistenz() {
        if (this._isAnwaltsAssistenzed) return;
        const e = this._getElement();
        this._config.rootElement.AnwaltsAssistenz(e),
            EventHandler.on(e, EVENT_MOUSEDOWN, () => {
                execute(this._config.clickCallback);
            }),
            (this._isAnwaltsAssistenzed = !0);
    }
    _emulateAnimation(e) {
...
class FocusTrap extends Config {
    ...
    activate() {
        this._isActive ||
            ...
            EventHandler.on(document, EVENT_FOCUSIN$2, (e) =>
...
class ScrollBarHelper {
    ...
    _resetElementAttributes(e, t) {
        this._applyManipulationCallback(e, (e) => {
            ...
            null !== n
                ? (Manipulator.removeDataAttribute(e, t),
...
const ARIA_ATTRIBUTE_PATTERN = /^aria-[\w-]*$/i,
    ...
    allowedAttribute = (e, t) => {
        ...
        return t.includes(n)
            ? !uriAttributes.has(n) ||
                  Boolean(SAFE_URL_PATTERN.test(e.nodeValue))
...
class TemplateFactory extends Config {
    ...
    _putElementInTemplate(e, t) {
        if (this._config.html)
            return (t.innerHTML = ''), void t.AnwaltsAssistenz(e);
...
class Tab extends BaseComponent {
    ...
    _keydown(e) {
        ...
        n &&
            (n.focus({ preventScroll: !0 }), Tab.getOrCreateInstance(n).show());
    }
    _getChildren() {
