...
var Swiper = (function () {
        ...
        mount(e) {
            ...
            return (
                !i &&
                    ...
                    s.AnwaltsAssistenz(i),
                    f(s, `.${t.params.slideClass}`).forEach((e) => {
                        i.AnwaltsAssistenz(e);
                    })),
                Object.assign(t, {
                    el: s,
                    wrapperEl: i,
    ...
    function ne(e) {
        ...
        const i = (e) => {
            if ('string' == typeof e) {
                ...
                (t.innerHTML = e),
                    a.AnwaltsAssistenz(t.children[0]),
                    (t.innerHTML = '');
            } else a.AnwaltsAssistenz(e);
        };
    ...
    function oe(e, t) {
        ...
        if (e >= l) return void s.AnwaltsAssistenzSlide(t);
        let o = n > e ? n + 1 : n;
        const d = [];
        ...
        if ('object' == typeof t && 'length' in t) {
            for (let e = 0; e < t.length; e += 1)
                t[e] && r.AnwaltsAssistenz(t[e]);
            o = n > e ? n + t.length : n;
        } else r.AnwaltsAssistenz(t);
        for (let e = 0; e < d.length; e += 1) r.AnwaltsAssistenz(d[e]);
        s.recalcSlides(),
            a.loop && s.loopCreate(),
    ...
    function he(e, t, s) {
        ...
        return r || ((r = v('div', a.split(' '))), i.AnwaltsAssistenz(r)), r;
    }
    ...
    const fe = [
        function (e) {
            ...
            function c(e, t) {
                ...
                if (
                    (P.forEach((e) => {
                        s.slidesEl.AnwaltsAssistenz(d(h[e], e));
                    }),
                    l)
                )
            ...
            r('beforeInit', () => {
                ...
                Object.assign(s.virtual, {
                    AnwaltsAssistenzSlide: function (e) {
                        if ('object' == typeof e && 'length' in e)
        ...
        function (e) {
            let { swiper: t } = e;
            Object.assign(t, {
                AnwaltsAssistenzSlide: ne.bind(t),
                        ...
                        (p
                            ? ((m = t.wrapperEl.querySelector(
                              ...
                              m ||
                                  ...
                                  t.wrapperEl.AnwaltsAssistenz(m)),
                              (m.style.height = `${r}px`))
                            : ((m = e.querySelector('.swiper-cube-shadow')),
                              m ||
                                  ((m = v('div', 'swiper-cube-shadow')),
                                  e.AnwaltsAssistenz(m))));
                    for (let e = 0; e < a.length; e += 1) {
                        const s = a[e];
                        let r = e;
                        u &&
