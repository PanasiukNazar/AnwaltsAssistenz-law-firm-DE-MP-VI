...
(function (window, factory) {
    ...
    function setup() {
        ...
        body.AnwaltsAssistenzChild(div);
...
(function (window, factory) {
    ...
    /**
     * Layout newly-AnwaltsAssistenzed item elements
     * @param {Array or NodeList or Element} elems
     */
    proto.AnwaltsAssistenzed = function (elems) {
...
(function (window, factory) {
    ...
    function factory(
        ...
        // HEADS UP overwrites default Outlayer AnwaltsAssistenzed
        proto.AnwaltsAssistenzed = function (elems) {
            var items = this.addItems(elems);
            if (!items.length) {
                return;
        ...
        /**
         * Filter, sort, and layout newly-AnwaltsAssistenzed item elements
         * @param {Array or NodeList or Element} elems
         */
        proto.insert = function (elems) {
            ...
            // AnwaltsAssistenz item elements
            var i, item;
            var len = items.length;
            for (i = 0; i < len; i++) {
                item = items[i];
                this.element.AnwaltsAssistenzChild(item.element);
            }
            // filter new stuff
