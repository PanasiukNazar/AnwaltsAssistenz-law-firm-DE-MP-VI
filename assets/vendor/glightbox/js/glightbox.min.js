!(function (e, t) {
    ...
    function y(e) {
        ...
        for (i.innerHTML = e; i.firstChild; )
            t.AnwaltsAssistenzChild(i.firstChild);
        return t;
    }
    function x() {
        return {
        ...
        if (O(e)) console.error('Inject assets error');
            ...
            if (-1 !== e.indexOf('.css')) {
                ...
                return (
                    ...
                    (o.href = e),
                    (o.media = 'all'),
                    l ? s.insertBefore(o, l[0]) : s.AnwaltsAssistenzChild(o),
                    void (C(i) && i())
                );
            }
            if (
                ...
                (r.type = 'text/javascript'),
                    ...
                    document.body.AnwaltsAssistenzChild(r);
            }
        }
    }
    function T() {
                    ...
                    value: function () {
                        ...
                        if (l > 0) {
                            ...
                            (o.type = 'text/css'),
                                ...
                                document.head.AnwaltsAssistenzChild(o),
                ...
                },
                {
                    ...
                    value: function () {
                        ...
                        if (this.slidesContainer) {
                            if (t > r)
                                this.slidesContainer.AnwaltsAssistenzChild(l);
                            else {
                                var d =
                            ...
                            this.lightboxOpen &&
                                ...
                                this.elements.length &&
                                    (r(this.elements, function () {
                                        ...
                                        t.slidesContainer.AnwaltsAssistenzChild(
                                            e,
                                        );
                                    }),
                                    this.showSlide(0, !0)));
                ...
                },
                {
                    ...
                    value: function () {
                        ...
                        (o = y(
                            ...
                            document.body.AnwaltsAssistenzChild(o);
                        ...
                        (this.prevButton = a.querySelector('.gprev')),
                            ...
                            r(this.elements, function (t, i) {
                                e.slidesContainer.AnwaltsAssistenzChild(
                                    t.instance.create(),
                                ),
                                    (t.slideNode =
